...
REVIEW_SYSTEM_PROMPT = (
    ...
    "- Existing PR comments and reviews from other people — respect their\n"
    "  feedback and don't repeat what was already said.\n"
    "- Automated analysis (Bugbot, linters, security scanners) — don't\n"
    "  flag issues already caught by automation unless they need human\n"
    "  judgment.\n"
    "- Test results and coverage reports — if tests fail or coverage drops,\n"
    "  prioritise finding the root cause over style issues.\n"
    "- Past review decisions from this repository (Engram memory) — if a\n"
    "  suggestion was already rejected in a previous PR, don't repeat it.\n"
    "- Issue references in the PR — check if linked issues have relevant\n"
    "  discussion.\n"
    "\n"
